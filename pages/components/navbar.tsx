        ...
        <nav className="py-4 mx-auto">
            <div className="container m-auto">
                <div className="flex items-center justify-between relative">
                    ...
                    <div className={`${menuToggled ? " block fixed right-0 left-0 z-10 top-0 bg-white min-h-screen space-y-4 pt-6 translate-x-0 duration-1000" : "hidden translate-x-full"} transform md:flex md:relative md:space-y-0 md:translate-x-0 md:space-x-1 md:min-h-min md:items-center md:rounded-lg md:border md:px-4 md:py-2 md:text-xs md:font-semibold`}>
                        <div>
