    ...
    return (
        <div>
            <div className="container mx-auto">
                ...
                <div className="grid md:grid-cols-6 gap-4 mx-10 mt-7">
                    <div className="col-span-4 mt-8 border-l">
                        <div className="grid md:grid-cols-3">
                            <div className="md:mt-9 ml-8">
                                <h6 className="text-sm text-gray-400"> 12 Sept, 2022 </h6>
                            </div>
                            <div className="col-span-2 px-4 py-7 rounded-xl text-gray-700 hover:bg-slate-50">
                    ...
                    <div className="col-span-2">
                        <div className="border rounded-xl mt-16 px-6 py-8">
                            <EnvelopeIcon className="inline w-6 h-6 text-slate-600" />
                            <p className="inline text-xs text-slate-600 font-semibold ml-3">
                                Stay up to date
                            </p>
                            ...
                            <div className="mt-4">
                                <form action="" method="post">
                                    <input type="email" name="email" id=""
                                        className="border py-2 px-3 rounded-md shadow inline text-sm"
                                        placeholder="Email address"
                                    />
                                    <button type="submit" 
                                    className="px-4 py-2 ml-2 text-sm text-slate-700 border rounded-md line"
                                    >
                                        Join
                                    </button>
                                </form>
