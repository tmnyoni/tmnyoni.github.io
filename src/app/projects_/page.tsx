...
import { CursorArrowRaysIcon, LinkIcon } from "@heroicons/react/24/outline";
          ...
          <div className="mt-2">
            <div className="rounded-xl px-4 py-7 hover:bg-slate-50">
              ...
              <p className="mt-3 text-sm">
                I am a contributor to the Lecui library which is a rapid UI
                development library created by
