...
export function DockItem({
    ...
    return (
        <Link
            ...
            {...props}
        >
            <div className="text-medium mb-1 hidden rounded bg-gray-300 px-3 py-1 text-xs opacity-0 duration-300 group-hover:block group-hover:scale-110 group-hover:opacity-90 dark:border dark:border-white dark:bg-black/90 ">
                {label}
            </div>
            ...
            <motion.div
                ref={ref}
                style={{ width }}
                className="flex aspect-square w-10 items-center justify-center  rounded-xl border border-gray-400 bg-gray-300 shadow-lg duration-100 active:scale-90 dark:bg-black"
            >
